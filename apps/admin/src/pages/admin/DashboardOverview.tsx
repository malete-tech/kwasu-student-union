  ...
  return (
    <div className="space-y-10">
      <div className="border-b border-slate-100 pb-8">
        <h2 className="text-2xl font-black text-brand-900 uppercase tracking-tight">System Overview</h2>
        <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-0.5">Real-time engagement & content metrics</p>
      </div>
      ...
      <Card className="shadow-2xl rounded-[2rem] border-none bg-slate-900 text-white overflow-hidden p-8">
        <CardTitle className="text-xl font-bold mb-6 text-brand-gold uppercase tracking-widest flex items-center gap-2">
