...
import { Loader2, ArrowLeft, FileText, Upload } from "@/components/ui/font-awesome-icon";
      ...
      <div className="max-w-5xl mx-auto space-y-10">
        <div className="flex items-center gap-4 border-b border-slate-100 pb-8">
          ...
          <div className="flex-1 min-w-0">
            <h2 className="text-lg font-semibold text-slate-900 truncate">Edit Document</h2>
