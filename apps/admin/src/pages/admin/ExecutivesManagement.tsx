  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-slate-100 pb-6">
        <div>
          <h2 className="text-2xl font-black text-brand-900 uppercase tracking-tight">Executive Council</h2>
          <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-0.5">Union Leadership & Bodies</p>
        </div>
        <div className="flex items-center gap-3">
          <Select value={councilFilter} onValueChange={(value: Executive['councilType'] | 'All') => setCouncilFilter(value)}>
            <SelectTrigger className="w-[180px] bg-white border-brand-100 rounded-xl focus:ring-brand-gold h-10 shadow-sm">
