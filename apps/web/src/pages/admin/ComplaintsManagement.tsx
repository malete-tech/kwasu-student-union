  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-brand-700">Student Grievances</h2>
          <p className="text-sm md:text-base text-muted-foreground mt-1">
            Review and manage reports filed by students across campus.
          </p>
        </div>
        <Badge variant="outline" className="h-9 px-4 rounded-xl border-brand-100 bg-brand-50/30 text-brand-700 text-xs font-bold uppercase tracking-wider">
