...
const SenateCouncil = () => {
  ...
  return (
    <>
      <SEO
        title="Senate Council | KWASU Students' Union"
        description="Meet the legislative Senate Council members of the Kwara State University Students' Union advocating for student rights and representation."
        url="https://kwasusu.com.ng/executives/senate"
      />

      <ExecutiveCouncilHeader
        title="Senate Council"
        subtitle="The legislative arm of the KWASU Students' Union representing student constituencies across departments and faculties."
        activeCouncil="Senate"
      />
        ...
        {loading ? (
          ...
          <div className="py-20 flex flex-col items-center text-center">
            ...
            <p className="text-sm font-semibold text-gray-500 mb-1">
              No Senate Council profiles available yet
            </p>
            <p className="text-xs text-gray-400">
              Senate directory entries will appear here once updated.
            </p>
          </div>
        )}
      </div>
