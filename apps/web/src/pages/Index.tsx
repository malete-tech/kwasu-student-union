...
const heroImages = [
  { url: "/about-gallery/photo1.jpg", caption: "Empowering Student Voices" },
  { url: "/about-gallery/photo2.jpg", caption: "Excellence in Leadership" },
  { url: "/about-gallery/photo3.jpg", caption: "Building Future Innovators" },
  { url: "/about-gallery/photo4.jpg", caption: "Campus Community & Synergy" },
  { url: "/about-gallery/photo5.jpg", caption: "Advocating for Every Student" },
  { url: "/about-gallery/photo6.jpg", caption: "A Legacy of Academic Pride" },
];
          ...
          <div className="container grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <FadeIn direction="left" duration={0.8} delay={0.2}>
              <div className="relative flex justify-center lg:justify-end w-full lg:w-auto">
                <HeroCarousel images={heroImages} className="w-full" />
              </div>
            </FadeIn>
          </div>
        </section>
