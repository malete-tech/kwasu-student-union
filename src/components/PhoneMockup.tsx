...
const PhoneMockup: React.FC<PhoneMockupProps> = ({ children, className }) => {
  return (
    <div className={cn(
      "relative w-[340px] h-[400px] md:w-[380px] md:h-[440px] lg:w-[420px] lg:h-[480px] rounded-[3rem] shadow-2xl overflow-hidden",
      ...
      <div className="absolute inset-[10px] bg-gray-900 rounded-[2.5rem] overflow-hidden flex items-center justify-center">
        {/* Phone Notch */}
