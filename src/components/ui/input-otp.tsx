...
const OTPInputContext = React.createContext<
  | {
      slots: SlotProps[];
      setSlots: React.Dispatch<React.SetStateAction<SlotProps[]>>;
    }
  | undefined
>(undefined);
...
const InputOTP = React.forwardRef<
  ...
  Omit<React.ComponentPropsWithoutRef<typeof OTPInput>, 'render'> & { children: React.ReactNode } // Omit 'render' prop when children are provided
