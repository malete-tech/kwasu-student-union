    ...
    <div className="space-y-6">
      ...
      <Card className="shadow-lg rounded-xl p-6">
        <CardHeader className="pb-4">
          <CardTitle className="text-xl font-semibold text-brand-700">Add New News Article</CardTitle>
        </CardHeader>
        <CardContent>
          <Form {...form}>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <ImageUpload
                        ...
                        folderPath="public" // Store directly in the public folder of the bucket
                        value={field.value}
