  ...
  return (
    <div className="space-y-6 md:space-y-8">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-brand-700">Ad Management Center</h2>
          <p className="text-sm md:text-base text-muted-foreground mt-1">Manage sponsored content and advertiser campaigns across the platform.</p>
        </div>
        <Button asChild className="bg-brand-700 hover:bg-brand-800 text-white rounded-xl shadow-md w-full sm:w-auto">
